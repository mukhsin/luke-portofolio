...
const projects: Project[] = [
    {
        code:        "01",
        title:       "Project 01",
        description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab ducimus explicabo facere incidunt laudantium sequi!",
        category:    "frontend",
        ...
        >
            <div className="container mx-auto">
                <div className="flex flex-col xl:flex-row xl:gap-[32px]">
                    <div
                        className="w-full xl:w-[50%] xl:h-[480px] flex flex-col xl:justify-between order-2 xl:order-none"
                    >
                            ...
                            <div className="flex items-center gap-4">
                                <Link href={ project.live }>
                                    <TooltipProvider>
                                        <Tooltip>
                                            <TooltipTrigger
                                                className="w-[72px] h-[72px] rounded-full bg-white/5 flex justify-center items-center group"
                                            >
                                                <BsArrowUpRight
                        ...
                        >
                            { projects.map( ( item, index ) => (
                                <SwiperSlide key={ index } className="w-full">
                                    <div
                                        className="h-[420px] relative group flex justify-center items-center bg-green-50/20"
                                    >
                                        {/* overlay */ }
