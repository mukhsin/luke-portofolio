...
const about: About = {
    title:       "About me",
    description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa facilis libero modi nisi obcaecati quis recusandae sit. Aliquam, amet, iste!",
    info:        [
        {
            name:  "Name",
            value: "Luke Coleman",
                                    ...
                                    { skills.items.map( ( item, index ) => (
                                        <li key={ index }>
                                            <TooltipProvider delayDuration={ 100 }>
                                                <Tooltip>
                                                    <TooltipTrigger
                                                        className="w-full h-[160px] bg-[#232329] rounded-xl flex justify-center items-center group"
                                                    >
                                                        <div
